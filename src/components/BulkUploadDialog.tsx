...
const BulkUploadDialog = ({ open, onOpenChange, onUpload }: BulkUploadDialogProps) => {
  ...
  const downloadTemplate = () => {
    const template = [
      { id: 'PROD001', name: 'Sample Product', price: 29.99, brand: 'Sample Brand', availability: 'In Stock' },
      { id: 'PROD002', name: 'Another Product', price: 49.99, brand: 'Another Brand', availability: 'Low Stock' }
    ];
